...
public class TimeEntryControllerTest {
    ...
    public void setUp() {
        ...
        DistributionSummary distributionSummary = mock(DistributionSummary.class);
        Counter counter = mock(Counter.class);

        doReturn(distributionSummary).when(meterRegistry).summary("timeEntry.summary");
        doReturn(counter).when(meterRegistry).counter("timeEntry.actionCounter");
